...
Gem::Specification.new do |s|
  ...
  s.date = "2012-07-05"
  s.description = "This is taken from XMLCanonicalizer/WSS4R and http://github.com/borisnadion/xml-canonicalizer"
  s.email = "andrewferk@gmail.com"
  s.extra_rdoc_files = [
    "LICENSE",
    "README.rdoc"
  ]
  s.files = [
    ...
    "test/withentities.xml",
    "tests.watchr",
    "xmlcanonicalizer.gemspec"
  ]
  s.homepage = "http://github.com/andrewferk/xmlcanonicalizer"
  s.require_paths = ["lib"]
